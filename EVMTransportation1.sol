...
contract EVMTransportation1
{
    ...
    constructor( address supplyChainObservers, bool SealSts, int pass1, string memory videoLink1) public
    {
...
//ComplianceDetail = "N/A";
    ...
    function TransferResponsibility(address newCounterparty, bool SealSt, string memory videoLink) public
    {
